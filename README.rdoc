...
* Define all roles as empty initially so tasks that mention them but do not need them won't error out.
* Add an optional default task so that this might be able to play nice with multi-stage.
